...
create_analysis_view -name WCZ_av -constraint_mode standard_cm -delay_corner WCZ_dc -latency_file ${::IMEX::dataVar}/mmmc/views/WCZ_av/latency.sdc
create_analysis_view -name ML_av -constraint_mode standard_cm -delay_corner ML_dc -latency_file ${::IMEX::dataVar}/mmmc/views/ML_av/latency.sdc
create_analysis_view -name TC_av -constraint_mode standard_cm -delay_corner TC_dc
create_analysis_view -name WCL_av -constraint_mode standard_cm -delay_corner WCL_dc -latency_file ${::IMEX::dataVar}/mmmc/views/WCL_av/latency.sdc
create_analysis_view -name LT_av -constraint_mode standard_cm -delay_corner LT_dc -latency_file ${::IMEX::dataVar}/mmmc/views/LT_av/latency.sdc
